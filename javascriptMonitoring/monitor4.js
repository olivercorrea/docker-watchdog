...
const docker = new Docker({ host: "http://34.228.73.135", port: 2375 });
...
const containerId = "digimon-microservice-container";
setInterval(() => getContainerStats(containerId), 5000);
